/ 2018.02.03T05:46:04.477 j1 weaves
/ q cars.load.q FILE [-bl|bulkload] [-bs|bulksave] [-js|justsym] [-exit] [-savedb SAVEDB] [-saveptn SAVEPTN] [-savename SAVENAME] 
/ q cars.load.q FILE
/ q cars.load.q
/ q cars.load.q -help
FILE:LOADFILE:`$":in/cars.csv"
o:.Q.opt .z.x;if[count .Q.x;FILE:hsym`${x[where"\\"=x]:"/";x}first .Q.x]
if[`help in key o;-1"usage: q cars.load.q [FILE(default:in/cars.csv)] [-help] [-bl|bulkload] [-bs|bulksave] [-js|justsym] [-savedb SAVEDB] [-saveptn SAVEPTN] [-savename SAVENAME] [-exit]\n";exit 1]
SAVEDB:`:csvdb
SAVEPTN:`
...
SAVENAME:`cars
LOADFMTS:"SSSHFF"
LOADHDRS:`lsoaname`lsoacode`carsinhousehold`numberofhouseholds`lat`long
...
JUSTSYMFMTS:"SSS   "
JUSTSYMHDRS:`lsoaname`lsoacode`carsinhousehold
