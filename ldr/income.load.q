/ 2018.02.03T05:46:05.095 j1 weaves
/ q income.load.q FILE [-bl|bulkload] [-bs|bulksave] [-js|justsym] [-exit] [-savedb SAVEDB] [-saveptn SAVEPTN] [-savename SAVENAME] 
/ q income.load.q FILE
/ q income.load.q
/ q income.load.q -help
FILE:LOADFILE:`$":in/income.csv"
o:.Q.opt .z.x;if[count .Q.x;FILE:hsym`${x[where"\\"=x]:"/";x}first .Q.x]
if[`help in key o;-1"usage: q income.load.q [FILE(default:in/income.csv)] [-help] [-bl|bulkload] [-bs|bulksave] [-js|justsym] [-savedb SAVEDB] [-saveptn SAVEPTN] [-savename SAVENAME] [-exit]\n";exit 1]
SAVEDB:`:csvdb
SAVEPTN:`
...
SAVENAME:`income
LOADFMTS:"SSSIHHHFF"
LOADHDRS:`lsoacode2011`lsoaname2011`localauthoritydistrictname2013`nationalincomerankwhere1lowest`hertsincomerank1islowest`nationalincomedecile1islowest`hertsincomedecile1islowest`lat`long
...
JUSTSYMFMTS:"SSS      "
JUSTSYMHDRS:`lsoacode2011`lsoaname2011`localauthoritydistrictname2013
