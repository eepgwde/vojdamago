/ 2018.02.03T05:46:04.761 j1 weaves
/ q tcars.load.q FILE [-bl|bulkload] [-bs|bulksave] [-js|justsym] [-exit] [-savedb SAVEDB] [-saveptn SAVEPTN] [-savename SAVENAME] 
/ q tcars.load.q FILE
/ q tcars.load.q
/ q tcars.load.q -help
FILE:LOADFILE:`$":in/tcars.csv"
o:.Q.opt .z.x;if[count .Q.x;FILE:hsym`${x[where"\\"=x]:"/";x}first .Q.x]
if[`help in key o;-1"usage: q tcars.load.q [FILE(default:in/tcars.csv)] [-help] [-bl|bulkload] [-bs|bulksave] [-js|justsym] [-savedb SAVEDB] [-saveptn SAVEPTN] [-savename SAVENAME] [-exit]\n";exit 1]
SAVEDB:`:csvdb
SAVEPTN:`
...
SAVENAME:`tcars
LOADFMTS:"SSHFF"
LOADHDRS:`lsoaname`lsoacode`totalcarsinarea`lat`long
