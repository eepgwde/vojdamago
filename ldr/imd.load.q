/ 2018.02.03T05:46:05.436 j1 weaves
/ q imd.load.q FILE [-bl|bulkload] [-bs|bulksave] [-js|justsym] [-exit] [-savedb SAVEDB] [-saveptn SAVEPTN] [-savename SAVENAME] 
/ q imd.load.q FILE
/ q imd.load.q
/ q imd.load.q -help
FILE:LOADFILE:`$":in/imd.csv"
o:.Q.opt .z.x;if[count .Q.x;FILE:hsym`${x[where"\\"=x]:"/";x}first .Q.x]
if[`help in key o;-1"usage: q imd.load.q [FILE(default:in/imd.csv)] [-help] [-bl|bulkload] [-bs|bulksave] [-js|justsym] [-savedb SAVEDB] [-saveptn SAVEPTN] [-savename SAVENAME] [-exit]\n";exit 1]
SAVEDB:`:csvdb
SAVEPTN:`
...
LOADNAME:`imd
SAVENAME:`imd
LOADFMTS:"SSSSSEIHHHFF"
LOADHDRS:`lsoacode2011`herts`lsoaname2011`localauthoritydistrictcode2013`localauthoritydistrictname2013`imdscore`nationalimdrankoutof32844`hertsimdrankoutof703`hertswealthrankoutof703`nationalwealthrankoutof32844`lat`long
...
JUSTSYMFMTS:"SSSSS       "
JUSTSYMHDRS:`lsoacode2011`herts`lsoaname2011`localauthoritydistrictcode2013`localauthoritydistrictname2013
