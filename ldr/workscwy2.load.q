/ 2018.03.13T13:25:30.491 j1 weaves
/ q workscwy2.load.q FILE [-bl|bulkload] [-bs|bulksave] [-js|justsym] [-exit] [-savedb SAVEDB] [-saveptn SAVEPTN] [-savename SAVENAME] 
/ q workscwy2.load.q FILE
/ q workscwy2.load.q
/ q workscwy2.load.q -help
FILE:LOADFILE:`$":../cache/in/workscwy2.csv"
o:.Q.opt .z.x;if[count .Q.x;FILE:hsym`${x[where"\\"=x]:"/";x}first .Q.x]
if[`help in key o;-1"usage: q workscwy2.load.q [FILE(default:../cache/in/workscwy2.csv)] [-help] [-bl|bulkload] [-bs|bulksave] [-js|justsym] [-savedb SAVEDB] [-saveptn SAVEPTN] [-savename SAVENAME] [-af|asfile] [-exit]\n";exit 1]
SAVEDB:`:csvdb
SAVEPTN:`
...
LOADNAME:`workscwy2
SAVENAME:`workscwy2
LOADFMTS:"SSSSSDSCSSSSS"
LOADHDRS:`iwpnumber`progcode`progsubcode`projectname`projectsubname`eventdate`treatment`eventtype`workasset`worktype`workseverity`featureid`sharedasset
...
JUSTSYMFMTS:"SSSSS S SSSSS"
JUSTSYMHDRS:`iwpnumber`progcode`progsubcode`projectname`projectsubname`treatment`workasset`worktype`workseverity`featureid`sharedasset
