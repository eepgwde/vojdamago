/ 2018.03.11T20:24:05.263 j1 weaves
/ q weather.load.q FILE [-bl|bulkload] [-bs|bulksave] [-js|justsym] [-exit] [-savedb SAVEDB] [-saveptn SAVEPTN] [-savename SAVENAME] 
/ q weather.load.q FILE
/ q weather.load.q
/ q weather.load.q -help
FILE:LOADFILE:`$":../cache/in/weather.csv"
o:.Q.opt .z.x;if[count .Q.x;FILE:hsym`${x[where"\\"=x]:"/";x}first .Q.x]
if[`help in key o;-1"usage: q weather.load.q [FILE(default:../cache/in/weather.csv)] [-help] [-bl|bulkload] [-bs|bulksave] [-js|justsym] [-savedb SAVEDB] [-saveptn SAVEPTN] [-savename SAVENAME] [-af|asfile] [-exit]\n";exit 1]
SAVEDB:`:csvdb
SAVEPTN:`
...
SAVENAME:`weather
LOADFMTS:"HHEEHEE"
LOADHDRS:`yyyy`mm`tmax`tmin`af`rain`sun
