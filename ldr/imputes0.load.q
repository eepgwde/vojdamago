/ 2021.08.05T12:33:03.755 emma weaves
/ q imputes0.load.q FILE [-bl|bulkload] [-bs|bulksave] [-js|justsym] [-exit] [-savedb SAVEDB] [-saveptn SAVEPTN] [-savename SAVENAME] 
/ q imputes0.load.q FILE
/ q imputes0.load.q
/ q imputes0.load.q -help
FILE:LOADFILE:`$":../cache/in/imputes0.csv"
o:.Q.opt .z.x;if[count .Q.x;FILE:hsym`${x[where"\\"=x]:"/";x}first .Q.x]
if[`help in key o;-1"usage: q imputes0.load.q [FILE(default:../cache/in/imputes0.csv)] [-help] [-bl|bulkload] [-bs|bulksave] [-js|justsym] [-savedb SAVEDB] [-saveptn SAVEPTN] [-savename SAVENAME] [-af|asfile] [-exit]\n";exit 1]
SAVEDB:`:csvdb
SAVEPTN:`
...
SAVENAME:`imputes0
LOADFMTS:"SHHFS"
LOADHDRS:`smpl0`emethod1`priority`response`estatus0
