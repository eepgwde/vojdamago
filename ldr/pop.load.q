/ 2018.02.03T05:46:05.689 j1 weaves
/ q pop.load.q FILE [-bl|bulkload] [-bs|bulksave] [-js|justsym] [-exit] [-savedb SAVEDB] [-saveptn SAVEPTN] [-savename SAVENAME] 
/ q pop.load.q FILE
/ q pop.load.q
/ q pop.load.q -help
FILE:LOADFILE:`$":in/pop.csv"
o:.Q.opt .z.x;if[count .Q.x;FILE:hsym`${x[where"\\"=x]:"/";x}first .Q.x]
if[`help in key o;-1"usage: q pop.load.q [FILE(default:in/pop.csv)] [-help] [-bl|bulkload] [-bs|bulksave] [-js|justsym] [-savedb SAVEDB] [-saveptn SAVEPTN] [-savename SAVENAME] [-exit]\n";exit 1]
SAVEDB:`:csvdb
SAVEPTN:`
...
SAVENAME:`pop
LOADFMTS:"SSSHFF"
LOADHDRS:`lsoacode`lsoaname`genderandage`population`lat`long
...
JUSTSYMFMTS:"SSS   "
JUSTSYMHDRS:`lsoacode`lsoaname`genderandage
