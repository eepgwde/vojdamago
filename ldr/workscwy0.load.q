/ 2018.03.13T13:25:07.499 j1 weaves
/ q workscwy0.load.q FILE [-bl|bulkload] [-bs|bulksave] [-js|justsym] [-exit] [-savedb SAVEDB] [-saveptn SAVEPTN] [-savename SAVENAME] 
/ q workscwy0.load.q FILE
/ q workscwy0.load.q
/ q workscwy0.load.q -help
FILE:LOADFILE:`$":../cache/in/workscwy0.csv"
o:.Q.opt .z.x;if[count .Q.x;FILE:hsym`${x[where"\\"=x]:"/";x}first .Q.x]
if[`help in key o;-1"usage: q workscwy0.load.q [FILE(default:../cache/in/workscwy0.csv)] [-help] [-bl|bulkload] [-bs|bulksave] [-js|justsym] [-savedb SAVEDB] [-saveptn SAVEPTN] [-savename SAVENAME] [-af|asfile] [-exit]\n";exit 1]
SAVEDB:`:csvdb
SAVEPTN:`
...
LOADNAME:`workscwy0
SAVENAME:`workscwy0
LOADFMTS:"SHDDCSSSDSS"
LOADHDRS:`projectname`deliveryyear`constructionstart`constructionfinish`eventtype`workasset`worktype`workseverity`eventdate`featureid`sharedasset
...
JUSTSYMFMTS:"S    SSS SS"
JUSTSYMHDRS:`projectname`workasset`worktype`workseverity`featureid`sharedasset
