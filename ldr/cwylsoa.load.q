/ 2018.02.03T04:39:39.460 j1 weaves
/ q cwylsoa.load.q FILE [-bl|bulkload] [-bs|bulksave] [-js|justsym] [-exit] [-savedb SAVEDB] [-saveptn SAVEPTN] [-savename SAVENAME] 
/ q cwylsoa.load.q FILE
/ q cwylsoa.load.q
/ q cwylsoa.load.q -help
FILE:LOADFILE:`$":in/cwylsoa.csv"
o:.Q.opt .z.x;if[count .Q.x;FILE:hsym`${x[where"\\"=x]:"/";x}first .Q.x]
if[`help in key o;-1"usage: q cwylsoa.load.q [FILE(default:in/cwylsoa.csv)] [-help] [-bl|bulkload] [-bs|bulksave] [-js|justsym] [-savedb SAVEDB] [-saveptn SAVEPTN] [-savename SAVENAME] [-exit]\n";exit 1]
SAVEDB:`:csvdb
SAVEPTN:`
...
SAVENAME:`cwylsoa
LOADFMTS:"SSS"
LOADHDRS:`name`feature_id`asset_id
...
JUSTSYMFMTS:"SSS"
JUSTSYMHDRS:`name`feature_id`asset_id
