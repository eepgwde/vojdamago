/ 2018.01.25T12:23:37.038 j1 weaves
/ q rcia.load.q FILE [-bl|bulkload] [-bs|bulksave] [-js|justsym] [-exit] [-savedb SAVEDB] [-saveptn SAVEPTN] [-savename SAVENAME] 
/ q rcia.load.q FILE
/ q rcia.load.q
/ q rcia.load.q -help
FILE:LOADFILE:`$":in/RCI-A.csv"
o:.Q.opt .z.x;if[count .Q.x;FILE:hsym`${x[where"\\"=x]:"/";x}first .Q.x]
if[`help in key o;-1"usage: q rcia.load.q [FILE(default:in/RCI-A.csv)] [-help] [-bl|bulkload] [-bs|bulksave] [-js|justsym] [-savedb SAVEDB] [-saveptn SAVEPTN] [-savename SAVENAME] [-exit]\n";exit 1]
SAVEDB:`:csvdb
SAVEPTN:`
...
LOADNAME:`rcia
SAVENAME:`rcia
LOADFMTS:"IEEHSSESIUES*IIZHSSCCSSSSIIZ"
LOADHDRS:`centralassetid`surveyobsstart`surveyobsend`xsplaneoffset`xspname`observetypename`surveyobsvalue`obsparmoptname`sitecode`plotnumber`assetidcode`sitename`featurelocation`featurekey`surveynumber`surveyfeatend`datasetkey`featureid`calclocation`nodekeystart`nodekeyend`surveyobsnotes`featuregroupcode`featuregroupname`xspcode`observetypekey`surveytypekey`surveyfeatend0
...
JUSTSYMFMTS:"    SS S   S     SS  SSSS   "
JUSTSYMHDRS:`xspname`observetypename`obsparmoptname`sitename`featureid`calclocation`surveyobsnotes`featuregroupcode`featuregroupname`xspcode
