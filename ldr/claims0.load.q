/ 2018.01.27T00:11:37.687 j1 weaves
/ q claims0.load.q FILE [-bl|bulkload] [-bs|bulksave] [-js|justsym] [-exit] [-savedb SAVEDB] [-saveptn SAVEPTN] [-savename SAVENAME] 
/ q claims0.load.q FILE
/ q claims0.load.q
/ q claims0.load.q -help
FILE:LOADFILE:`$":in/claims0.csv"
o:.Q.opt .z.x;if[count .Q.x;FILE:hsym`${x[where"\\"=x]:"/";x}first .Q.x]
if[`help in key o;-1"usage: q claims0.load.q [FILE(default:in/claims0.csv)] [-help] [-bl|bulkload] [-bs|bulksave] [-js|justsym] [-savedb SAVEDB] [-saveptn SAVEPTN] [-savename SAVENAME] [-exit]\n";exit 1]
SAVEDB:`:csvdb
SAVEPTN:`
...
LOADNAME:`claims0
SAVENAME:`claims0
LOADFMTS:"SSD**SSSSSFFFZ"
LOADHDRS:`claimnumber`status`lossdate`roadidfeatureid`roadname`covertype`claimtype`location`cause`detailcause`paidtotal`osreservetotal`incurredtotal`lossdate0
...
JUSTSYMFMTS:"SS   SSSSS    "
JUSTSYMHDRS:`claimnumber`status`covertype`claimtype`location`cause`detailcause
