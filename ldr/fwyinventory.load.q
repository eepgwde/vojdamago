/ 2018.01.25T20:10:05.660 j1 weaves
/ q fwyinventory.load.q FILE [-bl|bulkload] [-bs|bulksave] [-js|justsym] [-exit] [-savedb SAVEDB] [-saveptn SAVEPTN] [-savename SAVENAME] 
/ q fwyinventory.load.q FILE
/ q fwyinventory.load.q
/ q fwyinventory.load.q -help
FILE:LOADFILE:`$":in/FWY-inventory.csv"
o:.Q.opt .z.x;if[count .Q.x;FILE:hsym`${x[where"\\"=x]:"/";x}first .Q.x]
if[`help in key o;-1"usage: q fwyinventory.load.q [FILE(default:in/FWY-inventory.csv)] [-help] [-bl|bulkload] [-bs|bulksave] [-js|justsym] [-savedb SAVEDB] [-saveptn SAVEPTN] [-savename SAVENAME] [-exit]\n";exit 1]
SAVEDB:`:csvdb
SAVEPTN:`
...
LOADNAME:`fwyinventory
SAVENAME:`fwyinventory
LOADFMTS:"IHSSSSSSSSSSFFE"
LOADHDRS:`sitecode`assetnumber`sitename`centralassetid`assetid`featureidalias`townname`contractareaname`wardname`areaname`customername`siteclassname`featext1easting`featext1north`fwylength
...
JUSTSYMFMTS:"  SSSSSSSSSS   "
JUSTSYMHDRS:`sitename`centralassetid`assetid`featureidalias`townname`contractareaname`wardname`areaname`customername`siteclassname
