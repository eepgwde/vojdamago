/ 2018.03.11T20:23:45.510 j1 weaves
/ q luton.load.q FILE [-bl|bulkload] [-bs|bulksave] [-js|justsym] [-exit] [-savedb SAVEDB] [-saveptn SAVEPTN] [-savename SAVENAME] 
/ q luton.load.q FILE
/ q luton.load.q
/ q luton.load.q -help
FILE:LOADFILE:`$":../cache/in/luton.csv"
o:.Q.opt .z.x;if[count .Q.x;FILE:hsym`${x[where"\\"=x]:"/";x}first .Q.x]
if[`help in key o;-1"usage: q luton.load.q [FILE(default:../cache/in/luton.csv)] [-help] [-bl|bulkload] [-bs|bulksave] [-js|justsym] [-savedb SAVEDB] [-saveptn SAVEPTN] [-savename SAVENAME] [-af|asfile] [-exit]\n";exit 1]
SAVEDB:`:csvdb
SAVEPTN:`
...
SAVENAME:`luton
LOADFMTS:"DHHHHHHHHH*"
LOADHDRS:`date0`thi`tmn`tlo`dphi`dpmn`dplo`hhi`hmn`hlo`evnts
