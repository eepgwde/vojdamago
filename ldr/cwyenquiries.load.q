/ 2018.01.27T02:49:37.713 j1 weaves
/ q cwyenquiries.load.q FILE [-bl|bulkload] [-bs|bulksave] [-js|justsym] [-exit] [-savedb SAVEDB] [-saveptn SAVEPTN] [-savename SAVENAME] 
/ q cwyenquiries.load.q FILE
/ q cwyenquiries.load.q
/ q cwyenquiries.load.q -help
FILE:LOADFILE:`$":in/CWY-enquiries.csv"
o:.Q.opt .z.x;if[count .Q.x;FILE:hsym`${x[where"\\"=x]:"/";x}first .Q.x]
if[`help in key o;-1"usage: q cwyenquiries.load.q [FILE(default:in/CWY-enquiries.csv)] [-help] [-bl|bulkload] [-bs|bulksave] [-js|justsym] [-savedb SAVEDB] [-saveptn SAVEPTN] [-savename SAVENAME] [-exit]\n";exit 1]
SAVEDB:`:csvdb
SAVEPTN:`
...
LOADNAME:`cwyenquiries
SAVENAME:`cwyenquiries
LOADFMTS:"ISSS*SSSSSSSBZZZ"
LOADHDRS:`enquirynumber`extsystemname`method`enqstatusname`officername`sitename`assetid`areaname`wardname`servicename`subjectcode`subjectname`outstandingflag`enquirytime0`loggeddate0`followupdate0
...
JUSTSYMFMTS:" SSS SSSSSSS    "
JUSTSYMHDRS:`extsystemname`method`enqstatusname`sitename`assetid`areaname`wardname`servicename`subjectcode`subjectname
