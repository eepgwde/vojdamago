/ 2018.03.13T13:22:21.195 j1 weaves
/ q dfctcwy.load.q FILE [-bl|bulkload] [-bs|bulksave] [-js|justsym] [-exit] [-savedb SAVEDB] [-saveptn SAVEPTN] [-savename SAVENAME] 
/ q dfctcwy.load.q FILE
/ q dfctcwy.load.q
/ q dfctcwy.load.q -help
FILE:LOADFILE:`$":../cache/in/dfctcwy.csv"
o:.Q.opt .z.x;if[count .Q.x;FILE:hsym`${x[where"\\"=x]:"/";x}first .Q.x]
if[`help in key o;-1"usage: q dfctcwy.load.q [FILE(default:../cache/in/dfctcwy.csv)] [-help] [-bl|bulkload] [-bs|bulksave] [-js|justsym] [-savedb SAVEDB] [-saveptn SAVEPTN] [-savename SAVENAME] [-af|asfile] [-exit]\n";exit 1]
SAVEDB:`:csvdb
SAVEPTN:`
...
LOADNAME:`dfctcwy
SAVENAME:`dfctcwy
LOADFMTS:"IH*SICS*ZSS**BBSSISHS*CSS"
LOADHDRS:`usrn`assetnumber`street`featureid`number`supersedes`status`description`date0`type0`type0name`location`notes0`easting`northing`prioritycode`priorityname`jobnumber`stsflag`stscode`stsname`notes1`eventtype`superseded`stscoded
...
JUSTSYMFMTS:"   S  S  SS    SS S S  SS"
JUSTSYMHDRS:`featureid`sts`type0`type0name`prioritycode`priorityname`stsflag`stsname`superseded`stscoded
