/ 2018.01.25T21:00:46.527 j1 weaves
/ q claims.load.q FILE [-bl|bulkload] [-bs|bulksave] [-js|justsym] [-exit] [-savedb SAVEDB] [-saveptn SAVEPTN] [-savename SAVENAME] 
/ q claims.load.q FILE
/ q claims.load.q
/ q claims.load.q -help
FILE:LOADFILE:`$":in/claims.csv"
o:.Q.opt .z.x;if[count .Q.x;FILE:hsym`${x[where"\\"=x]:"/";x}first .Q.x]
if[`help in key o;-1"usage: q claims.load.q [FILE(default:in/claims.csv)] [-help] [-bl|bulkload] [-bs|bulksave] [-js|justsym] [-savedb SAVEDB] [-saveptn SAVEPTN] [-savename SAVENAME] [-exit]\n";exit 1]
SAVEDB:`:csvdb
SAVEPTN:`
...
LOADNAME:`claims
SAVENAME:`claims
LOADFMTS:"SSSDSSSSSEEE*S*SZ*SZ"
LOADHDRS:`claimnumber`status`locationlevelf`lossdate`coveragegroup`covertype`risktype`cause`detailcause`paidtotal`osreservetotal`incurredtotal`accidentdescription`outcome`customerenquiryreference`inspectionfrequency`lastinspectiondatebeforeincident`roadidfeatureid`sitecode`lossdate0
...
JUSTSYMFMTS:"SSS SSSSS    S S  S "
JUSTSYMHDRS:`claimnumber`status`locationlevelf`coveragegroup`covertype`risktype`cause`detailcause`outcome`inspectionfrequency`sitecode
