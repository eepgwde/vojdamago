/ 2018.01.25T20:11:17.372 j1 weaves
/ q cwyinventory.load.q FILE [-bl|bulkload] [-bs|bulksave] [-js|justsym] [-exit] [-savedb SAVEDB] [-saveptn SAVEPTN] [-savename SAVENAME] 
/ q cwyinventory.load.q FILE
/ q cwyinventory.load.q
/ q cwyinventory.load.q -help
FILE:LOADFILE:`$":in/CWY-inventory.csv"
o:.Q.opt .z.x;if[count .Q.x;FILE:hsym`${x[where"\\"=x]:"/";x}first .Q.x]
if[`help in key o;-1"usage: q cwyinventory.load.q [FILE(default:in/CWY-inventory.csv)] [-help] [-bl|bulkload] [-bs|bulksave] [-js|justsym] [-savedb SAVEDB] [-saveptn SAVEPTN] [-savename SAVENAME] [-exit]\n";exit 1]
SAVEDB:`:csvdb
SAVEPTN:`
...
LOADNAME:`cwyinventory
SAVENAME:`cwyinventory
LOADFMTS:"SSISSSSSSSSESSSFFSSESS"
LOADHDRS:`assetid`featureid`siteid`sitename`locality`town`location`hierarchy`roadclass`customer`areaname`distance`ward`roadtypehw`urbanrural`featcenteast`featcentnorth`wardcode`surftype`width`roadtype`roadhierarchy
...
JUSTSYMFMTS:"SS SSSSSSSS SSS  SS SS"
JUSTSYMHDRS:`assetid`featureid`sitename`locality`town`location`hierarchy`roadclass`customer`areaname`ward`roadtypehw`urbanrural`wardcode`surftype`roadtype`roadhierarchy
