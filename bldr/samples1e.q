...
refiner0: { [x;cwys0;mstr0] cwys: cwys0[x;`cwy0]; x0:select from mstr0 where cwy0 in cwys }

r0: { [dt0;mstr0;n0;tag0;cwys0;ddt] tbl: refiner0[dt0 - ddt;cwys0;mstr0]; .hcc.smpl2risk1[tbl; dt0; n0; tag0; ddt] }[;samples1;n0;tag1;t1;ddt] each kt1

// r0 is a list of keyed tables, they have be unkeyed, joined, and aggregated
// to cwy0 and date0
r0: { 0!x } each r0
a00: `cwy0`date0 xasc raze r0;
...
r0: { [dt0;mstr0;n0;tag0;cwys0;ddt] tbl: refiner0[dt0 - ddt;cwys0;mstr0]; .hcc.smpl2risk1[tbl; dt0; n0; tag0; ddt] }[;samples1;n0;"";t1;ddt] each -5#kt1
...
x1: `cwy0`date0 xasc select by smpl0 from tsym where date0 within dts;
...
g2: select smpl1:count i, smplwt1: wts[dt00 - date0] wsum (count i)#1, smplrisk1: wts[dt00 - date0] wsum (count i)#1 wsum priority by cwy0 from g1;
